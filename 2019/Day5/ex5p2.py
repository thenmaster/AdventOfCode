...
while i < len(code):
	...
	if (opcode == 99):
		...
		if not options:
			...
			# 	var2 = code[i+2]
			# if len(options) >= 2 and options[1] == '1':
			# 	var1 = code[i+1]
			# print("Vars")
			# print(var1)
			# print(var2)
